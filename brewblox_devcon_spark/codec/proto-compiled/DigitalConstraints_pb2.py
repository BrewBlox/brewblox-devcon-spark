...
_MUTEXED = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='holdTimeRemaining', full_name='blox.Mutexed.holdTimeRemaining', index=3,
