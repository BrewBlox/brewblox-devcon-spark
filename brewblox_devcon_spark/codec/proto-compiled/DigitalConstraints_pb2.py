...
_MUTEXED = _descriptor.Descriptor(
  name='Mutexed',
  full_name='blox.DigitalConstraints.Mutexed',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='mutexId', full_name='blox.DigitalConstraints.Mutexed.mutexId', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='extraHoldTime', full_name='blox.DigitalConstraints.Mutexed.extraHoldTime', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='hasCustomHoldTime', full_name='blox.DigitalConstraints.Mutexed.hasCustomHoldTime', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='hasLock', full_name='blox.DigitalConstraints.Mutexed.hasLock', index=3,
...
_DIGITALCONSTRAINT = _descriptor.Descriptor(
  ...
  full_name='blox.DigitalConstraints.DigitalConstraint',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='minOff', full_name='blox.DigitalConstraints.DigitalConstraint.minOff', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\002\010\003\212\265\030\003\020\350\007\222?\0028 ', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='minOn', full_name='blox.DigitalConstraints.DigitalConstraint.minOn', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\002\010\003\212\265\030\003\020\350\007\222?\0028 ', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mutexed', full_name='blox.DigitalConstraints.DigitalConstraint.mutexed', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delayedOff', full_name='blox.DigitalConstraints.DigitalConstraint.delayedOff', index=3,
      ...
      serialized_options=b'\212\265\030\002\010\003\212\265\030\003\020\350\007\222?\0028 ', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='delayedOn', full_name='blox.DigitalConstraints.DigitalConstraint.delayedOn', index=4,
      ...
      serialized_options=b'\212\265\030\002\010\003\212\265\030\003\020\350\007\222?\0028 ', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='mutex', full_name='blox.DigitalConstraints.DigitalConstraint.mutex', index=5,
      ...
      serialized_options=b'\212\265\030\002\030\010\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='limiting', full_name='blox.DigitalConstraints.DigitalConstraint.limiting', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='remaining', full_name='blox.DigitalConstraints.DigitalConstraint.remaining', index=7,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='constraint', full_name='blox.DigitalConstraints.DigitalConstraint.constraint',
...
_DIGITALCONSTRAINTS = _descriptor.Descriptor(
  ...
  full_name='blox.DigitalConstraints.DigitalConstraints',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='constraints', full_name='blox.DigitalConstraints.DigitalConstraints.constraints', index=0,
...
Mutexed = _reflection.GeneratedProtocolMessageType('Mutexed', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:blox.DigitalConstraints.Mutexed)
  })
...
DigitalConstraint = _reflection.GeneratedProtocolMessageType('DigitalConstraint', (_message.Message,), {
  ...
  '__module__' : 'DigitalConstraints_pb2'
  # @@protoc_insertion_point(class_scope:blox.DigitalConstraints.DigitalConstraint)
  })
...
DigitalConstraints = _reflection.GeneratedProtocolMessageType('DigitalConstraints', (_message.Message,), {
  ...
  '__module__' : 'DigitalConstraints_pb2'
  # @@protoc_insertion_point(class_scope:blox.DigitalConstraints.DigitalConstraints)
  })
