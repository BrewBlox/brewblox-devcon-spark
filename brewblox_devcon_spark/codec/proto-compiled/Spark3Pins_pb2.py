...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x10Spark3Pins.proto\x12\x04\x62lox\x1a\x0e\x62rewblox.proto\x1a\x0cnanopb.proto\x1a\rIoArray.proto\"\x9e\x03\n\nSpark3Pins\x12\x35\n\x04pins\x18\x01 \x03(\x0b\x32\x16.blox.Spark3Pins.IoPinB\x0f\x92?\x02\x10\x05\x92?\x02x\x01\x9a?\x02(\x01\x12\x18\n\x10\x65nableIoSupply5V\x18\x02 \x01(\x08\x12\x19\n\x11\x65nableIoSupply12V\x18\x03 \x01(\x08\x12\x12\n\nsoundAlarm\x18\x05 \x01(\x08\x12\"\n\x08voltage5\x18\x06 \x01(\rB\x10\x9a?\x02(\x01\x92?\x02\x38\x10\x9a?\x03\x10\x9a\x03\x12#\n\tvoltage12\x18\x07 \x01(\rB\x10\x9a?\x02(\x01\x92?\x02\x38\x10\x9a?\x03\x10\x95\x01\x1a\xb9\x01\n\x05IoPin\x12\x1f\n\x04top1\x18\x01 \x01(\x0b\x32\x0f.blox.IoChannelH\x00\x12\x1f\n\x04top2\x18\x02 \x01(\x0b\x32\x0f.blox.IoChannelH\x00\x12\x1f\n\x04top3\x18\x03 \x01(\x0b\x32\x0f.blox.IoChannelH\x00\x12\"\n\x07\x62ottom1\x18\x04 \x01(\x0b\x32\x0f.blox.IoChannelH\x00\x12\"\n\x07\x62ottom2\x18\x05 \x01(\x0b\x32\x0f.blox.IoChannelH\x00\x42\x05\n\x03Pin:\x0b\x9a?\x03\x18\xbf\x02\x9a?\x02H\nb\x06proto3')
  ,
...
_SPARK3PINS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\222?\002\020\005\222?\002x\001\232?\002(\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='soundAlarm', full_name='blox.Spark3Pins.soundAlarm', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='voltage5', full_name='blox.Spark3Pins.voltage5', index=4,
      number=6, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\232?\002(\001\222?\0028\020\232?\003\020\232\003'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='voltage12', full_name='blox.Spark3Pins.voltage12', index=5,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\232?\002(\001\222?\0028\020\232?\003\020\225\001'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  ...
  serialized_options=_b('\232?\003\030\277\002\232?\002H\n'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
