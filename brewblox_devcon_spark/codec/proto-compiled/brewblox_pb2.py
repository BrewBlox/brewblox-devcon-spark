...
_BREWBLOXOPTIONS_BLOCKTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='Spark2Pins', index=34, number=320,
      serialized_options=None,
      type=None),
  ],
