...
_WIDGET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222?\002\010\003\222?\002x\001\212\265\030\0028\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\003\030\260\002\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='pressure', full_name='blox.DisplaySettings.Widget.pressure', index=7,
      number=15, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\003\030\312\002\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='chem', full_name='blox.DisplaySettings.Widget.chem', index=8,
      number=16, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\003\030\313\002\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_BLOCK = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\222?\002\020\006', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
    ...
    _descriptor.FieldDescriptor(
      name='brightness', full_name='blox.DisplaySettings.Block.brightness', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='timeZone', full_name='blox.DisplaySettings.Block.timeZone', index=3,
      ...
      serialized_options=b'\212\265\030\002H\001\222?\002\030\003', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tempUnit', full_name='blox.DisplaySettings.Block.tempUnit', index=4,
...
_WIDGET.oneofs_by_name['WidgetType'].fields.append(
  _WIDGET.fields_by_name['pressure'])
_WIDGET.fields_by_name['pressure'].containing_oneof = _WIDGET.oneofs_by_name['WidgetType']
_WIDGET.oneofs_by_name['WidgetType'].fields.append(
  _WIDGET.fields_by_name['chem'])
_WIDGET.fields_by_name['chem'].containing_oneof = _WIDGET.oneofs_by_name['WidgetType']
