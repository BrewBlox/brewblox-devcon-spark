...
_DISPLAYSETTINGS_TEMPERATUREUNIT = _descriptor.EnumDescriptor(
  ...
  full_name='blox.DisplaySettings.DisplaySettings.TemperatureUnit',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_DISPLAYSETTINGS = _descriptor.Descriptor(
  ...
  full_name='blox.DisplaySettings.DisplaySettings',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='widgets', full_name='blox.DisplaySettings.DisplaySettings.widgets', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='blox.DisplaySettings.DisplaySettings.name', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='tempUnit', full_name='blox.DisplaySettings.DisplaySettings.tempUnit', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='brightness', full_name='blox.DisplaySettings.DisplaySettings.brightness', index=3,
      ...
      serialized_options=b'\222?\0028\010', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='timeZone', full_name='blox.DisplaySettings.DisplaySettings.timeZone', index=4,
...
DisplaySettings = _reflection.GeneratedProtocolMessageType('DisplaySettings', (_message.Message,), {
  ...
  '__module__' : 'DisplaySettings_pb2'
  # @@protoc_insertion_point(class_scope:blox.DisplaySettings.DisplaySettings)
  })
