...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _WIDGET.fields_by_name['pos']._serialized_options = b'\222?\0028\010\212\265\030\002x\001'
  _WIDGET.fields_by_name['color']._options = None
  _WIDGET.fields_by_name['color']._serialized_options = b'\222?\004\010\003x\001\212\265\030\0048\001x\001'
  _WIDGET.fields_by_name['name']._options = None
  _WIDGET.fields_by_name['name']._serialized_options = b'\222?\002\010\020\212\265\030\002x\001'
  _WIDGET.fields_by_name['tempSensor']._options = None
  _WIDGET.fields_by_name['tempSensor']._serialized_options = b'\222?\0028\020\212\265\030\004\030\002x\001'
  _WIDGET.fields_by_name['setpointSensorPair']._options = None
  _WIDGET.fields_by_name['setpointSensorPair']._serialized_options = b'\222?\0028\020\212\265\030\004\030\004x\001'
  _WIDGET.fields_by_name['actuatorAnalog']._options = None
  _WIDGET.fields_by_name['actuatorAnalog']._serialized_options = b'\222?\0028\020\212\265\030\004\030\005x\001'
  _WIDGET.fields_by_name['pid']._options = None
  _WIDGET.fields_by_name['pid']._serialized_options = b'\222?\0028\020\212\265\030\005\030\260\002x\001'
  _BLOCK.fields_by_name['widgets']._options = None
  _BLOCK.fields_by_name['widgets']._serialized_options = b'\222?\002\020\006\212\265\030\002x\001'
  _BLOCK.fields_by_name['name']._options = None
  _BLOCK.fields_by_name['name']._serialized_options = b'\222?\002\010(\212\265\030\002x\001'
  ...
  _globals['_WIDGET']._serialized_end=339
  _globals['_BLOCK']._serialized_start=342
  _globals['_BLOCK']._serialized_end=540
