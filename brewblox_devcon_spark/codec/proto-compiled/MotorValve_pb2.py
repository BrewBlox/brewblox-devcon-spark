...
_MOTORVALVE = _descriptor.Descriptor(
  ...
  serialized_options=_b('\212\265\030\003\030\301\002'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
