...
_MOTORVALVE_VALVESTATE = _descriptor.EnumDescriptor(
  name='ValveState',
  full_name='blox.MotorValve.MotorValve.ValveState',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_MOTORVALVE = _descriptor.Descriptor(
  name='MotorValve',
  full_name='blox.MotorValve.MotorValve',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='hwDevice', full_name='blox.MotorValve.MotorValve.hwDevice', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\002\030\013\212\265\030\002@\001\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='startChannel', full_name='blox.MotorValve.MotorValve.startChannel', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='state', full_name='blox.MotorValve.MotorValve.state', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='constrainedBy', full_name='blox.MotorValve.MotorValve.constrainedBy', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='valveState', full_name='blox.MotorValve.MotorValve.valveState', index=4,
      ...
      serialized_options=b'\212\265\030\0020\001\212\265\030\002(\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='desiredState', full_name='blox.MotorValve.MotorValve.desiredState', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.MotorValve.MotorValve.strippedFields', index=6,
  ...
  serialized_options=b'\212\265\030\003\030\301\002\212\265\030\002H\006',
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
MotorValve = _reflection.GeneratedProtocolMessageType('MotorValve', (_message.Message,), {
  'DESCRIPTOR' : _MOTORVALVE,
  '__module__' : 'MotorValve_pb2'
  # @@protoc_insertion_point(class_scope:blox.MotorValve.MotorValve)
  })
