...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_DIGITALSTATE']._options = None
  _globals['_DIGITALSTATE']._serialized_options = b'\020\001'
  _globals['_IOCHANNEL'].fields_by_name['id']._options = None
  _globals['_IOCHANNEL'].fields_by_name['id']._serialized_options = b'\222?\0028\010\212\265\030\002(\001'
  _globals['_IOCHANNEL'].fields_by_name['capabilities']._options = None
  _globals['_IOCHANNEL'].fields_by_name['capabilities']._serialized_options = b'\222?\0028\020\212\265\030\004(\001P\001'
  _globals['_IOCHANNEL'].fields_by_name['claimedBy']._options = None
  _globals['_IOCHANNEL'].fields_by_name['claimedBy']._serialized_options = b'\212\265\030\005\030\377\001(\001'
