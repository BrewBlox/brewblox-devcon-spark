...
_DIGITALSTATE = DESCRIPTOR.enum_types_by_name['DigitalState']
DigitalState = enum_type_wrapper.EnumTypeWrapper(_DIGITALSTATE)
_TRANSITIONDURATIONPRESET = DESCRIPTOR.enum_types_by_name['TransitionDurationPreset']
TransitionDurationPreset = enum_type_wrapper.EnumTypeWrapper(_TRANSITIONDURATIONPRESET)
_CHANNELCAPABILITIES = DESCRIPTOR.enum_types_by_name['ChannelCapabilities']
ChannelCapabilities = enum_type_wrapper.EnumTypeWrapper(_CHANNELCAPABILITIES)
_PWMFREQUENCY = DESCRIPTOR.enum_types_by_name['PwmFrequency']
...
_IOCHANNEL = DESCRIPTOR.message_types_by_name['IoChannel']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _IOCHANNEL.fields_by_name['capabilities']._serialized_options = b'\212\265\030\002P\001\212\265\030\002(\001\222?\0028\020'
  _IOCHANNEL.fields_by_name['claimedBy']._options = None
  _IOCHANNEL.fields_by_name['claimedBy']._serialized_options = b'\212\265\030\003\030\377\001\212\265\030\002(\001\222?\0028\020'
  _DIGITALSTATE._serialized_start=174
  _DIGITALSTATE._serialized_end=307
  _TRANSITIONDURATIONPRESET._serialized_start=309
  _TRANSITIONDURATIONPRESET._serialized_end=403
  _CHANNELCAPABILITIES._serialized_start=406
  _CHANNELCAPABILITIES._serialized_end=667
  _PWMFREQUENCY._serialized_start=669
  _PWMFREQUENCY._serialized_end=763
  _IOCHANNEL._serialized_start=61
  _IOCHANNEL._serialized_end=171
