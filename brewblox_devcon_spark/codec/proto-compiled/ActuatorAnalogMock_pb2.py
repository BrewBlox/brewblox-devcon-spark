...
_BLOCK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.ActuatorAnalogMock.Block.strippedFields', index=8,
