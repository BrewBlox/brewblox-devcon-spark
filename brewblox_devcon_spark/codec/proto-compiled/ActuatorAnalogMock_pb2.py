...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BLOCK.fields_by_name['minSetting']._serialized_options = b'\222?\0028 \212\265\030\005\020\200 x\001'
  _BLOCK.fields_by_name['maxSetting']._options = None
  _BLOCK.fields_by_name['maxSetting']._serialized_options = b'\222?\0028 \212\265\030\005\020\200 x\001'
  _BLOCK.fields_by_name['minValue']._options = None
  _BLOCK.fields_by_name['minValue']._serialized_options = b'\222?\0028 \212\265\030\005\020\200 x\001'
  _BLOCK.fields_by_name['maxValue']._options = None
  _BLOCK.fields_by_name['maxValue']._serialized_options = b'\222?\0028 \212\265\030\005\020\200 x\001'
  ...
  _globals['_BLOCK']._serialized_end=682
