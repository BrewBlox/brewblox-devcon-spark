...
_BALANCER = _descriptor.Descriptor(
  name='Balancer',
  full_name='blox.Balancer.Balancer',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='clients', full_name='blox.Balancer.Balancer.clients', index=0,
...
Balancer = _reflection.GeneratedProtocolMessageType('Balancer', (_message.Message,), {
  ...
  '__module__' : 'Balancer_pb2'
  # @@protoc_insertion_point(class_scope:blox.Balancer.Balancer)
  })
