...
_BLOCK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='clearFaults', full_name='blox.OneWireGpioModule.Block.clearFaults', index=15,
