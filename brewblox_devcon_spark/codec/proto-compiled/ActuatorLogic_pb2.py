...
_COMPARE_RESULT = _descriptor.EnumDescriptor(
  name='Result',
  full_name='blox.ActuatorLogic.Compare.Result',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_COMPARE_DIGITALOPERATOR = _descriptor.EnumDescriptor(
  ...
  full_name='blox.ActuatorLogic.Compare.DigitalOperator',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_COMPARE_ANALOGOPERATOR = _descriptor.EnumDescriptor(
  name='AnalogOperator',
  full_name='blox.ActuatorLogic.Compare.AnalogOperator',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_COMPARE = _descriptor.Descriptor(
  name='Compare',
  full_name='blox.ActuatorLogic.Compare',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_ACTUATORLOGIC = _descriptor.Descriptor(
  name='ActuatorLogic',
  full_name='blox.ActuatorLogic.ActuatorLogic',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='targetId', full_name='blox.ActuatorLogic.ActuatorLogic.targetId', index=0,
      ...
      serialized_options=b'\212\265\030\002\030\006\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='drivenTargetId', full_name='blox.ActuatorLogic.ActuatorLogic.drivenTargetId', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='enabled', full_name='blox.ActuatorLogic.ActuatorLogic.enabled', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='result', full_name='blox.ActuatorLogic.ActuatorLogic.result', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='expression', full_name='blox.ActuatorLogic.ActuatorLogic.expression', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='digital', full_name='blox.ActuatorLogic.ActuatorLogic.digital', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='analog', full_name='blox.ActuatorLogic.ActuatorLogic.analog', index=6,
      ...
      serialized_options=b'\222?\002\020\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='errorPos', full_name='blox.ActuatorLogic.ActuatorLogic.errorPos', index=7,
...
Compare = _reflection.GeneratedProtocolMessageType('Compare', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:blox.ActuatorLogic.Compare)
  })
...
ActuatorLogic = _reflection.GeneratedProtocolMessageType('ActuatorLogic', (_message.Message,), {
  ...
  '__module__' : 'ActuatorLogic_pb2'
  # @@protoc_insertion_point(class_scope:blox.ActuatorLogic.ActuatorLogic)
  })
