...
_HARDWARE = _descriptor.EnumDescriptor(
    name='Hardware',
...
_sym_db.RegisterEnumDescriptor(_HARDWARE)
...
_BLOCK.fields_by_name['hardware'].enum_type = _HARDWARE
...
DESCRIPTOR.enum_types_by_name['Hardware'] = _HARDWARE
