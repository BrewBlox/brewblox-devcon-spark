...
_SETPOINTPROFILE = _descriptor.Descriptor(
  ...
  full_name='blox.SetpointProfile.SetpointProfile',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='points', full_name='blox.SetpointProfile.SetpointProfile.points', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enabled', full_name='blox.SetpointProfile.SetpointProfile.enabled', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='targetId', full_name='blox.SetpointProfile.SetpointProfile.targetId', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='drivenTargetId', full_name='blox.SetpointProfile.SetpointProfile.drivenTargetId', index=3,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\003\030\257\002\212\265\030\002@\001\222?\0028\020\212\265\030\002(\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='start', full_name='blox.SetpointProfile.SetpointProfile.start', index=4,
...
SetpointProfile = _reflection.GeneratedProtocolMessageType('SetpointProfile', (_message.Message,), {
  ...
  '__module__' : 'SetpointProfile_pb2'
  # @@protoc_insertion_point(class_scope:blox.SetpointProfile.SetpointProfile)
  })
