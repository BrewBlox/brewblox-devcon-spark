...
_BLOCK = _descriptor.Descriptor(
  name='Block',
  full_name='blox.TempSensorOneWire.Block',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='blox.TempSensorOneWire.Block.value', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='offset', full_name='blox.TempSensorOneWire.Block.offset', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='blox.TempSensorOneWire.Block.address', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='oneWireBusId', full_name='blox.TempSensorOneWire.Block.oneWireBusId', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.TempSensorOneWire.Block.strippedFields', index=4,
