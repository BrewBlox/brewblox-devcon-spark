...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x17TempSensorOneWire.proto\x12\x04\x62lox\x1a\x0e\x62rewblox.proto\x1a\x0cnanopb.proto\"\xa6\x01\n\x11TempSensorOneWire\x12+\n\x05value\x18\x01 \x01(\x11\x42\x1c\x8a\xb5\x18\x06\n\x04\x64\x65gC\x8a\xb5\x18\x03\x10\x80 \x92?\x02\x38 \x8a\xb5\x18\x02(\x01\x12\x15\n\x05valid\x18\x02 \x01(\x08\x42\x06\x8a\xb5\x18\x02(\x01\x12,\n\x06offset\x18\x03 \x01(\x11\x42\x1c\x8a\xb5\x18\x0c\n\ndelta_degC\x8a\xb5\x18\x03\x10\x80 \x92?\x02\x38 \x12\x17\n\x07\x61\x64\x64ress\x18\x04 \x01(\x06\x42\x06\x8a\xb5\x18\x02 \x01:\x06\x92?\x03H\xae\x02\x62\x06proto3')
  ,
...
_TEMPSENSORONEWIRE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='valid', full_name='blox.TempSensorOneWire.valid', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='offset', full_name='blox.TempSensorOneWire.offset', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='address', full_name='blox.TempSensorOneWire.address', index=3,
  ...
  serialized_options=_b('\222?\003H\256\002'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_TEMPSENSORONEWIRE.fields_by_name['valid']._options = None
