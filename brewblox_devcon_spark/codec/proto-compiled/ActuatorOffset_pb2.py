...
_ACTUATOROFFSET_REFERENCEKIND = _descriptor.EnumDescriptor(
  name='ReferenceKind',
  full_name='blox.ActuatorOffset.ActuatorOffset.ReferenceKind',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_ACTUATOROFFSET = _descriptor.Descriptor(
  name='ActuatorOffset',
  full_name='blox.ActuatorOffset.ActuatorOffset',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='targetId', full_name='blox.ActuatorOffset.ActuatorOffset.targetId', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='referenceId', full_name='blox.ActuatorOffset.ActuatorOffset.referenceId', index=1,
      ...
      serialized_options=b'\212\265\030\002\030\001\222?\0028\020', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='referenceSettingOrValue', full_name='blox.ActuatorOffset.ActuatorOffset.referenceSettingOrValue', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='setting', full_name='blox.ActuatorOffset.ActuatorOffset.setting', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='blox.ActuatorOffset.ActuatorOffset.value', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='constrainedBy', full_name='blox.ActuatorOffset.ActuatorOffset.constrainedBy', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='drivenTargetId', full_name='blox.ActuatorOffset.ActuatorOffset.drivenTargetId', index=6,
      number=9, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\002\030\001\212\265\030\002@\001\222?\0028\020\212\265\030\002(\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enabled', full_name='blox.ActuatorOffset.ActuatorOffset.enabled', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='desiredSetting', full_name='blox.ActuatorOffset.ActuatorOffset.desiredSetting', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.ActuatorOffset.ActuatorOffset.strippedFields', index=9,
      number=99, type=13, cpp_type=3, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\002(\001\222?\0028\020\222?\002\020\002', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
ActuatorOffset = _reflection.GeneratedProtocolMessageType('ActuatorOffset', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:blox.ActuatorOffset.ActuatorOffset)
  })
