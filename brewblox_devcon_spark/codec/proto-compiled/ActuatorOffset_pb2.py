...
_ACTUATOROFFSET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.ActuatorOffset.strippedFields', index=7,
