...
_ACTUATORPWM = _descriptor.Descriptor(
  name='ActuatorPwm',
  full_name='blox.ActuatorPwm.ActuatorPwm',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='actuatorId', full_name='blox.ActuatorPwm.ActuatorPwm.actuatorId', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='period', full_name='blox.ActuatorPwm.ActuatorPwm.period', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='setting', full_name='blox.ActuatorPwm.ActuatorPwm.setting', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='blox.ActuatorPwm.ActuatorPwm.value', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='constrainedBy', full_name='blox.ActuatorPwm.ActuatorPwm.constrainedBy', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='drivenActuatorId', full_name='blox.ActuatorPwm.ActuatorPwm.drivenActuatorId', index=5,
      number=7, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\212\265\030\002\030\006\212\265\030\002@\001\222?\0028\020\212\265\030\002(\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='enabled', full_name='blox.ActuatorPwm.ActuatorPwm.enabled', index=6,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='desiredSetting', full_name='blox.ActuatorPwm.ActuatorPwm.desiredSetting', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.ActuatorPwm.ActuatorPwm.strippedFields', index=8,
...
ActuatorPwm = _reflection.GeneratedProtocolMessageType('ActuatorPwm', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:blox.ActuatorPwm.ActuatorPwm)
  })
