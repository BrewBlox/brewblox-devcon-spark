...
_ACTUATORPWM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='strippedFields', full_name='blox.ActuatorPwm.strippedFields', index=6,
