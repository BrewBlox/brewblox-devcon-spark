...
_BLOCK = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='drivenTargetId', full_name='blox.ActuatorPwm.Block.drivenTargetId', index=8,
