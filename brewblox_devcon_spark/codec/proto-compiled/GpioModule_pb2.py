...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CHANNEL.fields_by_name['id']._serialized_options = b'\222?\0028\010\212\265\030\002x\001'
  _CHANNEL.fields_by_name['deviceType']._options = None
  _CHANNEL.fields_by_name['deviceType']._serialized_options = b'\212\265\030\002x\001'
  _CHANNEL.fields_by_name['pinsMask']._options = None
  _CHANNEL.fields_by_name['pinsMask']._serialized_options = b'\222?\0028\010\212\265\030\004P\001x\001'
  _CHANNEL.fields_by_name['width']._options = None
  _CHANNEL.fields_by_name['width']._serialized_options = b'\222?\0028\010\212\265\030\002x\001'
  _CHANNEL.fields_by_name['name']._options = None
  _CHANNEL.fields_by_name['name']._serialized_options = b'\222?\002\010 \212\265\030\002x\001'
  ...
  _CHANNEL.fields_by_name['errorFlags']._serialized_options = b'\222?\0028\010\212\265\030\004P\001x\001'
  ...
  _globals['_DEVICETYPE']._serialized_start=881
  _globals['_DEVICETYPE']._serialized_end=1562
  _globals['_ERRORFLAGS']._serialized_start=1565
  _globals['_ERRORFLAGS']._serialized_end=1827
  _globals['_CHANNEL']._serialized_start=68
  _globals['_CHANNEL']._serialized_end=354
  _globals['_STATUS']._serialized_start=357
  _globals['_STATUS']._serialized_end=878
